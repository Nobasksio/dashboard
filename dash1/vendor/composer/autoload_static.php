...
class ComposerStaticInitbf7bb61cbc816c48ded0a06c98296aa9
{
    ...
    public static $classMap = array (
        ...
        'UserModelTest' => __DIR__ . '/../..' . '/tests/UserModelTest.php',
        'application\\controller\\AdminController' => __DIR__ . '/../..' . '/application/controller/AdminController.php',
        'application\\controller\\AuthController' => __DIR__ . '/../..' . '/application/controller/AuthController.php',
        'application\\controller\\BaseController' => __DIR__ . '/../..' . '/application/controller/BaseController.php',
        'application\\controller\\BasketController' => __DIR__ . '/../..' . '/application/controller/BasketController.php',
        'application\\controller\\DashboardController' => __DIR__ . '/../..' . '/application/controller/DashboardController.php',
        'application\\controller\\HomeController' => __DIR__ . '/../..' . '/application/controller/HomeController.php',
        'application\\controller\\MarketingController' => __DIR__ . '/../..' . '/application/controller/MarketingController.php',
        'application\\controller\\ProductController' => __DIR__ . '/../..' . '/application/controller/ProductController.php',
        'application\\controller\\UserController' => __DIR__ . '/../..' . '/application/controller/UserController.php',
        'application\\controller\\WaitersController' => __DIR__ . '/../..' . '/application/controller/WaitersController.php',
        'application\\model\\AdminModel' => __DIR__ . '/../..' . '/application/model/AdminModel.php',
        'application\\model\\AuthModel' => __DIR__ . '/../..' . '/application/model/AuthModel.php',
        'application\\model\\BaseModel' => __DIR__ . '/../..' . '/application/model/BaseModel.php',
        ...
        'application\\model\\UserModel' => __DIR__ . '/../..' . '/application/model/UserModel.php',
        'application\\model\\WaitersModel' => __DIR__ . '/../..' . '/application/model/WaitersModel.php',
        'application\\service\\Autoloader' => __DIR__ . '/../..' . '/application/service/Autoloader.php',
        'application\\service\\Config' => __DIR__ . '/../..' . '/application/service/Config.php',
        'application\\service\\FrontController' => __DIR__ . '/../..' . '/application/service/FrontController.php',
        'application\\service\\Request' => __DIR__ . '/../..' . '/application/service/Request.php',
        'application\\service\\Service' => __DIR__ . '/../..' . '/application/service/Service.php',
        'application\\service\\Session' => __DIR__ . '/../..' . '/application/service/Session.php',
        'application\\service\\View' => __DIR__ . '/../..' . '/application/service/View.php',
        'tests\\BaseTest' => __DIR__ . '/../..' . '/tests/BaseTest.php',
        'tests\\HomeControllerTest' => __DIR__ . '/../..' . '/tests/HomeControllerTest.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInitbf7bb61cbc816c48ded0a06c98296aa9::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInitbf7bb61cbc816c48ded0a06c98296aa9::$prefixDirsPsr4;
            $loader->prefixesPsr0 = ComposerStaticInitbf7bb61cbc816c48ded0a06c98296aa9::$prefixesPsr0;
            $loader->classMap = ComposerStaticInitbf7bb61cbc816c48ded0a06c98296aa9::$classMap;

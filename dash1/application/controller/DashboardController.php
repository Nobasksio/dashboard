...
class DashboardController extends BaseController
{
    ...
    public function action_brand()
    {
        ...
        $dash_array = $dashModel->startTypeDash($this->right, 'brand', $this->date_start, $this->date_finish, $month, $id_b);
    ...
    public function action_department()
    {
        ...
        $dashModel = new DashboardModel;
        $dash_array = $dashModel->startTypeDash(array($rigth), 'department', $this->date_start, $this->date_finish, $month);
